...
The ERDDAP data can be loaded in the same way using `load_erddap()`. This function has no arguments (the dataset does not include data from the inactive stations or the early suveys).
